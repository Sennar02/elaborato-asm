...
char *
retrieve_input(char *filename, char *input, size_t size); // funzione di supporto che prende in input il nome del file
                                                          // e modifica la stringa input da passare come parametro alla funzione assembly
void
write_output(char *filename, char *output); // Scrive il risultato su un file di output
